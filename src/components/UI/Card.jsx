  ...
  return (
    <>
      {showModal && createPortal(
        <Modal onClick={() => setShowModal(false)} theme={mode} note={note} />, document.body
      )}
        ...
        <h3 className="flex text-xl font-semibold mb-1 items-center">
          ...
          <span>
            <svg
              ...
              viewBox="0 0 20 20"
              className="w-4 h-4 ml-2 font-normal fill-current hover:text-[#d8524a]"
            >
              <path
                fillRule="evenodd"
          ...
          <svg
            ...
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 20 20"
            className="w-4 h-4 ml-2 font-normal fill-current hover:text-gray-500"
          >
